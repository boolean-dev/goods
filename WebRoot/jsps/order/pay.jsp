...
<div class="divContent">
	<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${total }</span>
	<span class="spanOid">编号：${oid }</span>
</div>
...
<div class="divBank">
	...
	<div style="margin: 40px;">
		<a href="OrderServlet?method=editStatue&oid=${oid }&statue=2" class="linkNext">支付</a>
	</div>
</div>
</form>
  </body>
